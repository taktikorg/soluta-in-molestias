...
For standalone usage, install the `@taktikorg/soluta-in-molestias` package:

```bash
# NPM
npm install @taktikorg/soluta-in-molestias

# Yarn
yarn add @taktikorg/soluta-in-molestias
```
...
The Reselect docs are available at **https://@taktikorg/soluta-in-molestias.js.org**, and include usage guides and API references:

- [**Introduction**](#https://@taktikorg/soluta-in-molestias.js.org/introduction/getting-started)
- [**How Does Reselect Work?**](#https://@taktikorg/soluta-in-molestias.js.org/introduction/how-does-@taktikorg/soluta-in-molestias-work)
- **API Reference**:
  - **[`createSelector`]**
  - **[`createSelectorCreator`]**
  - **[`createStructuredSelector`]**
  - [**Development-Only Stability Checks**](#https://@taktikorg/soluta-in-molestias.js.org/api/development-only-stability-checks)
  - **[`lruMemoize`]**
  - **[`weakMapMemoize`]**
- [**FAQ**](#https://@taktikorg/soluta-in-molestias.js.org/FAQ)
...
You can play around with the following **example** in [this CodeSandbox](https://codesandbox.io/s/@taktikorg/soluta-in-molestias-example-g3k9gf?file=/src/index.js):

```ts
import { createSelector } from '@taktikorg/soluta-in-molestias'
...
[build-badge]: https://img.shields.io/github/actions/workflow/status/reduxjs/@taktikorg/soluta-in-molestias/build-and-test-types.yml?branch=master&style=for-the-badge
[build]: https://github.com/taktikorg/soluta-in-molestias/actions/workflows/build-and-test-types.yml
[npm-badge]: https://img.shields.io/npm/v/@taktikorg/soluta-in-molestias.svg?style=for-the-badge
[npm]: https://www.npmjs.org/package/@taktikorg/soluta-in-molestias
[coveralls-badge]: https://img.shields.io/coveralls/reduxjs/@taktikorg/soluta-in-molestias/master.svg?style=for-the-badge
[coveralls]: https://coveralls.io/github/reduxjs/@taktikorg/soluta-in-molestias
...
[output selector fields]: https://@taktikorg/soluta-in-molestias.js.org/api/createSelector#output-selector-fields 'Output Selector Fields'
[`createSelector`]: https://@taktikorg/soluta-in-molestias.js.org/api/createSelector 'createSelector'
[`createSelectorCreator`]: https://@taktikorg/soluta-in-molestias.js.org/api/createSelectorCreator 'createSelectorCreator'
[`lruMemoize`]: https://@taktikorg/soluta-in-molestias.js.org/api/lruMemoize 'lruMemoize'
[`weakMapMemoize`]: https://@taktikorg/soluta-in-molestias.js.org/api/weakMapMemoize 'weakMapMemoize'
[`createStructuredSelector`]: https://@taktikorg/soluta-in-molestias.js.org/api/createStructuredSelector 'createStructuredSelector'
